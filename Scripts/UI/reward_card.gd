...
@onready var name_label:Button = $Button/VBoxContainer/SkillLabel
@onready var cast_time_label:Button =  $Button/VBoxContainer/CastTimeLabel
@onready var damage_label:Button =  $Button/VBoxContainer/DamageLabel
